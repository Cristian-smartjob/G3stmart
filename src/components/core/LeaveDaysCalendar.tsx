...
export default function LeaveDaysCalendar() {
  return (
    <div>
      ...
      <section className="mt-12">
        <h2 className="text-base font-semibold text-gray-900">Últimos dias</h2>
        <ol className="mt-2 divide-y divide-gray-200 text-sm/6 text-gray-500">
          <li className="py-4 sm:flex">
            <time dateTime="2022-01-20" className="w-28 flex-none">
              Vie, Ene 14
            </time>
            <p className="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Salida medico</p>
