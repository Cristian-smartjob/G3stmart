...
export default function PeopleTable(){
  ...
  const [selectedSmarter, setSelectedSmarter] = useState<People | null>(null)
  ...
  const handleActionPress = (item: People) => {
            ...
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div className="w-full md:w-1/2">
                    <form className="flex items-center">
                        ...
                        <button id="actionsDropdownButton" onClick={handleClickFilter} data-dropdown-toggle="actionsDropdown" className="w-full ml-4 md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="button">
